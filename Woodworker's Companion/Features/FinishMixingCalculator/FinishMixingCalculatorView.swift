//
//  FinishMixingCalculatorView.swift
...
struct FinishMixingCalculatorView: View {
  ...
  var body: some View {
    ...
    .overlay {
      if showingSummary {
        ToolSummaryModal(
          toolName: "Finish Mixing Calculator",
          summary: summary,
...
#Preview {
  FinishMixingCalculatorView(inDevelopment: true, summary: ToolSummaries.finishMixingCalculator)
}
